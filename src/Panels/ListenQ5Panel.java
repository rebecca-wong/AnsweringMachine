...
public class ListenQ5Panel extends Panel {
    ...
    public ListenQ5Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
    		...
    		///// Make labels ///////
    		questionLabel1 = new JLabel("\"Any tips on how to land a design internship?\""); 
		questionLabel2 = new JLabel(""); 
		answer1Label = new JLabel("May 11th, 2018                                                              2:45 pm");
		answer2Label = new JLabel("May 16th, 2018                                                              4:12 pm");
		answer3Label = new JLabel("");
		qNumLabel = new JLabel("Q5");
    ...
    public void PressedA() {
    		if(!bPressed) {
    			showScreen(Panel.BROWSEP2_2PANEL);
    		}
    }
