...
public class Question7Panel extends Panel {
    ...
    public Question7Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
    		...
    		///// Make labels ///////
    		questionLabel1 = new JLabel("\"Which design clubs/RSOs should I join "); 
		questionLabel2 = new JLabel("if any and why?\"");
		responsesLabel = new JLabel("2 responses"); 
		headerQuestion1 = new JLabel("Q7");
