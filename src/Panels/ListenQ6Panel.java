...
public class ListenQ6Panel extends Panel {
    ...
    public ListenQ6Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
		...
		answer1Label = new JLabel("May 15th, 2018                                                              5:43 pm");
		answer2Label = new JLabel("May 18th, 2018                                                              3:39 pm");
		answer3Label = new JLabel("");
		qNumLabel = new JLabel("Q6");
