...
public class ListenQ1_2Panel extends Panel {
    ...
    public ListenQ1_2Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
		...
		answer1Label = new JLabel("April 18th, 2018                                                          3:00 pm");
		answer2Label = new JLabel("May 7th, 2018                                                             5:12 pm");
		answer3Label = new JLabel("");
		qNumLabel = new JLabel("Q1");
    ...
    public void PressedUp() {
    		showScreen(Panel.LISTENQ1_1PANEL);
    }
