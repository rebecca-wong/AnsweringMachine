...
public class BrowseP3_3Panel extends Panel {
    ...
    public BrowseP3_3Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void PressedUp() {
        showScreen(Panel.BROWSEP3_2PANEL);
    }

    public void PressedDown() {
        showScreen(Panel.BROWSEP4_1PANEL);
    }
    ...
    public void PressedB() {
    		showScreen(Panel.LISTENQ9_PANEL);
