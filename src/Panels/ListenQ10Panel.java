...
public class ListenQ10Panel extends Panel {
    ...
    public ListenQ10Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
    		...
    		///// Make labels ///////
    		questionLabel1 = new JLabel("\"What are your favorite aspects of "); 
		questionLabel2 = new JLabel("the design major?\""); 
		answer1Label = new JLabel("May 15th, 2018                                                              4:28 pm");
		answer2Label = new JLabel("May 20th, 2018                                                              2:56 pm");
		answer3Label = new JLabel("");
		qNumLabel = new JLabel("Q10");
