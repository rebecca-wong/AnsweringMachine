...
public class ListenQ9Panel extends Panel {
    ...
    public ListenQ9Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
    		...
    		///// Make labels ///////
    		questionLabel1 = new JLabel("\"What are aspects of the design major"); 
		questionLabel2 = new JLabel("that you wish were different?\""); 
		answer1Label = new JLabel("May 7th, 2018                                                               2:36 pm");
		answer2Label = new JLabel("May 13th, 2018                                                              5:11 pm");
		answer3Label = new JLabel("");
		qNumLabel = new JLabel("Q9");
