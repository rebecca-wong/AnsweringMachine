...
public class ListenQ8Panel extends Panel {
    ...
    public ListenQ8Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
		...
		answer1Label = new JLabel("May 20th, 2018                                                              8:03 pm");
		answer2Label = new JLabel("May 22th, 2018                                                              4:28 pm");
		answer3Label = new JLabel("");
		qNumLabel = new JLabel("Q8");
