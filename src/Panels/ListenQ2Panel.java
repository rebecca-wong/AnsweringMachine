...
public class ListenQ2Panel extends Panel {
    ...
    public ListenQ2Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
		...
		answer1Label = new JLabel("May 4th, 2018                                                              12:37 pm");
		answer2Label = new JLabel("May 20th, 2018                                                             11:25 am");
		answer3Label = new JLabel("");
		qNumLabel = new JLabel("Q2");
