...
public class BrowseP3_2Panel extends Panel {
	
	JLabel questionLabel1;
	JLabel questionLabel2;
	JLabel question2Label1;
	JLabel question2Label2;
    ...
    public BrowseP3_2Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
    		...
    		///// Make labels ///////
    		questionLabel1 = new JLabel("\"Which design clubs/RSOs should I join if any"); 
		questionLabel2 = new JLabel("and why?\""); 
		question2Label1 = new JLabel("\"Do you like the design major or do you wish");
		question2Label2 = new JLabel("you chose a different major?\"");
		question3Label1 = new JLabel("\"What are aspects of the design major you wish");
		question3Label2 = new JLabel("were different?\"");
		q1Label = new JLabel("Q7");
		q2Label = new JLabel("Q8");
		q3Label = new JLabel("Q9");
		q1responsesLabel = new JLabel("2 responses");
		q2responsesLabel = new JLabel("2 responses");
		q3responsesLabel = new JLabel("1 response");
		headerQuestion1 = new JLabel("P3");
    ...
    public void setOptions() {
        ...
        question2Label2.setFont(this.customFont(TextAttribute.WEIGHT_BOLD, 20));
        question2Label2.setForeground(Color.WHITE);
        question2Label2.setBackground(Color.BLACK);
        question2Label2.setOpaque(true);
        sl.putConstraint(SpringLayout.WEST, question2Label2, this.mainX(), SpringLayout.WEST, this);
        sl.putConstraint(SpringLayout.NORTH, question2Label2, this.mainY() + this.scaledY(205), SpringLayout.NORTH, this);
    ...
    public void PressedB() {
    	showScreen(Panel.LISTENQ8_PANEL);
