...
public class ListenQ3Panel extends Panel {
    ...
    public ListenQ3Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
		...
		answer1Label = new JLabel("May 15th, 2018                                                              6:24 pm");
		answer2Label = new JLabel("May 21th, 2018                                                              3:49 pm");
		answer3Label = new JLabel("");
		qNumLabel = new JLabel("Q3");
    ...
    public void PressedA() {
    		if(!bPressed) {
    			showScreen(Panel.BROWSEP1_3PANEL);
    		}
    }
