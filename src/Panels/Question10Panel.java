...
public class Question10Panel extends Panel {
    ...
    public Question10Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
    		...
    		///// Make labels ///////
    		questionLabel1 = new JLabel("\"What are you favorite aspects"); 
		questionLabel2 = new JLabel("of the design major?\"");
		responsesLabel = new JLabel("1 response"); 
		headerQuestion1 = new JLabel("Q10");
