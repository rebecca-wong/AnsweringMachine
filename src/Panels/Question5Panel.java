...
public class Question5Panel extends Panel {
    ...
    public Question5Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
    		...
    		///// Make labels ///////
    		questionLabel1 = new JLabel("\"Any tips on how to land"); 
		questionLabel2 = new JLabel("a design internship?\"");
		responsesLabel = new JLabel("2 responses"); 
		headerQuestion1 = new JLabel("Q5");
