...
public class Question6Panel extends Panel {
    ...
    public Question6Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
    		...
    		///// Make labels ///////
    		questionLabel1 = new JLabel("\"What elements make a strong portfolio?\""); 
		questionLabel2 = new JLabel("");
		responsesLabel = new JLabel("1 response"); 
		headerQuestion1 = new JLabel("Q6");
    ...
    public void setOptions() {
        ...
        sl.putConstraint(SpringLayout.NORTH, responsesLabel, this.mainY() + this.scaledY(145), SpringLayout.NORTH, this);
