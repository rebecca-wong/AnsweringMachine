...
public class ListenQ4Panel extends Panel {
    ...
    public ListenQ4Panel(JPanel screens) {
        super(screens);
    }
    ...
    public void gui() {
    		...
    		///// Make labels ///////
    		questionLabel1 = new JLabel("\"What advice do you have for someone trying"); 
		questionLabel2 = new JLabel("to choose between all the design majors?\""); 
		answer1Label = new JLabel("May 7th, 2018                                                              2:56 pm");
		answer2Label = new JLabel("May 9th, 2018                                                              3:55 pm");
		answer3Label = new JLabel("May 10th, 2018                                                             1:23 pm");
		qNumLabel = new JLabel("Q4");
    ...
    public void setOptions() {
        ...
        sl.putConstraint(SpringLayout.NORTH, answer3Label, this.mainY() + this.scaledY(320), SpringLayout.NORTH, this);
        ...
        sl.putConstraint(SpringLayout.NORTH, a3Label, this.mainY() + this.scaledY(320), SpringLayout.NORTH, this);
    ...
    public void PressedUp() {
    		...
    		if(!bPressed && ansNum < 4 && ansNum > 0) {
    			if(ansNum == 2) {
            		...
            		answer1Label.setBackground(Color.BLACK);
            		answer1Label.setOpaque(true);
            		answer3Label.setForeground(Color.BLACK);
        			answer3Label.setOpaque(false);
    			} else if (ansNum == 3) {
    				ansNum = 2;
    ...
    public void PressedB() {
    		...
    		if (!bPressed) {
        		...
        		answer3Label.setForeground(new Color(0f, 0f, 0f, 0.2f));
        		...
        		a3Label.setForeground(new Color(0f, 0f, 0f, 0.2f));
        		...
        		answer3Label.setForeground(new Color(0f, 0f, 0f, 1f));
        		...
        		a3Label.setForeground(new Color(0f, 0f, 0f, 1f));
